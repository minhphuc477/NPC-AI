...
public:
    ...
    struct InferenceConfig {
        ...
        bool retrieval_guard_state_conditioned_enabled = true;
        float retrieval_guard_lambda_conflict = 1.25f;
        float retrieval_guard_lambda_task = 1.0f;
        float retrieval_guard_lambda_social = 0.8f;
        bool retrieval_state_conditioned_fusion_enabled = true;
        float retrieval_dense_weight_conflict = 0.72f;
        float retrieval_dense_weight_task = 0.58f;
        float retrieval_dense_weight_social = 0.65f;
        bool retrieval_query_aware_fusion_enabled = true;
        float retrieval_lexical_low_overlap_threshold = 0.22f;
        float retrieval_lexical_high_overlap_threshold = 0.55f;
        float retrieval_lexical_dense_boost_low_overlap = 0.12f;
        float retrieval_lexical_sparse_boost_high_overlap = 0.12f;
        bool use_cuda = true;
        int num_threads = 4;
        ...
        bool response_control_state_conditioned_scoring_enabled = true;
        bool response_control_state_conditioned_acceptance_enabled = true;
        float response_control_low_risk_context_relax = 0.05f;
        float response_control_low_risk_persona_relax = 0.03f;
        float response_control_low_risk_candidate_score_relax = 0.03f;
        float response_control_high_risk_context_tighten = 0.04f;
        float response_control_high_risk_persona_tighten = 0.02f;
        float response_control_high_risk_candidate_score_tighten = 0.03f;
