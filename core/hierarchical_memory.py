...
class HierarchicalMemorySystem:
    ...
    def add_episodic(self, content: str, importance: float = 0.5, 
                     participants: Optional[List[str]] = None, **kwargs) -> EpisodicMemory:
        """Add episodic memory"""
    ...
    def retrieve_episodic(self, query: Optional[str] = None, top_k: int = 5, 
                          min_importance: Optional[float] = None) -> List[EpisodicMemory]:
    ...
    def retrieve_semantic(self, category: Optional[str] = None, top_k: int = 10) -> List[SemanticMemory]:
    ...
    def retrieve_procedural(self, trigger: Optional[str] = None) -> List[ProceduralMemory]:
