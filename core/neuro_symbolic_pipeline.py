...
nx = _optional_module("networkx")
_llama_mod = _optional_module("llama_cpp")
Llama = getattr(_llama_mod, "Llama", None) if _llama_mod is not None else None
_st_mod = _optional_module("sentence_transformers")
SentenceTransformer = getattr(_st_mod, "SentenceTransformer", None) if _st_mod is not None else None
_splitter_mod = _optional_module("langchain_text_splitters")
RecursiveCharacterTextSplitter = (
    getattr(_splitter_mod, "RecursiveCharacterTextSplitter", None) if _splitter_mod is not None else None
)
