...
def control_response(
    ...
    raw_score = _candidate_score(cleaned, persona, active_context_keywords, persona_keywords)
    ...
    if cleaned:
        ...
        if grounded_candidate:
            ...
            grounded_score = _candidate_score(grounded_candidate, persona, active_context_keywords, persona_keywords)
    ...
    if config.enable_rewrite and rewrite_fn is not None:
        ...
        for attempt_idx, temp in enumerate(_rewrite_temperatures(config)[:rewrite_budget]):
            ...
            rewrite_score = _candidate_score(rewritten, persona, active_context_keywords, persona_keywords)
    ...
    fallback_score = _candidate_score(fallback, persona, active_context_keywords, persona_keywords)
