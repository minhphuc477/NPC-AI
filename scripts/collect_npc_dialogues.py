...
collector_mod = importlib.import_module("collect_npc_dialogues_FIXED")
OllamaClient = getattr(collector_mod, "OllamaClient")
generate_real_training_data = getattr(collector_mod, "generate_real_training_data")
