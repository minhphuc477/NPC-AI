...
try:
    ...
    if not hasattr(DynamicCache, "get_usable_length"):
        ...
        setattr(cast(Any, DynamicCache), "get_usable_length", get_usable_length)
except ImportError:
    print("DynamicCache not available in this transformers build; skipping compatibility patch.")
