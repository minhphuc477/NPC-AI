...
def main() -> None:
    ...
    parser.add_argument("--output-json", default="storage/artifacts/publication_profiles/live_runtime_summary.json")
    parser.add_argument("--output-md", default="storage/artifacts/publication_profiles/live_runtime_summary.md")
