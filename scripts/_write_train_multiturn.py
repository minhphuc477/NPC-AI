"""Helper script to write train_multiturn.py with correct special tokens."""
import os

ast_token = "<" + "|assistant|" + ">"
response_template_line = 'RESPONSE_TEMPLATE = "' + ast_token + '" + "\\n"'
...
target = r'c:\\Users\\MPhuc\\Desktop\\NPC AI\\scripts\\train_multiturn.py'
