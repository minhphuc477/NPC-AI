...
# Define the cells manually to ensure correctness and include optimizations
cells = [
    {
        "cell_type": "markdown",
        "metadata": {},
    ...
    },
    {
        ...
        "source": [
            "# ============================================================\n",
            "# Cell 5: GGUF Export (with Memory Management)\n",
            "# ============================================================\n",
            "from unsloth import FastLanguageModel\n",
...
with open(notebook_path, 'w', encoding='utf-8') as f:
    json.dump(notebook_data, f, indent=1, ensure_ascii=True)

print("Notebook restored and optimized successfully.")
