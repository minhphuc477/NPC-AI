...
def main() -> None:
    ...
    parser.add_argument("--proposal-root", default="artifacts/proposal")
    ...
    parser.add_argument("--output-json", default="artifacts/proposal_multiseed/multiseed_aggregate.json")
    parser.add_argument("--output-md", default="artifacts/proposal_multiseed/multiseed_aggregate.md")
