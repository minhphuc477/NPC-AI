...
def quantize_to_int4_gptq(
    ...
    try:
        auto_gptq_mod = importlib.import_module("auto_gptq")
        AutoGPTQForCausalLM = getattr(auto_gptq_mod, "AutoGPTQForCausalLM")
        BaseQuantizeConfig = getattr(auto_gptq_mod, "BaseQuantizeConfig")
    except ImportError:
...
def quantize_to_int4_awq(
    ...
    try:
        awq_mod = importlib.import_module("awq")
        AutoAWQForCausalLM = getattr(awq_mod, "AutoAWQForCausalLM")
    except ImportError:
